...
<div class='w-screen h-screen flex justify-center items-center bg-[url("https://cdn.pixabay.com/photo/2020/03/25/13/03/house-4967221_1280.jpg")]'>
            ...
            @endif --}}
				...
				<form class=' space-y-6' action="/blog/{{ $post->slug }}" method="post" enctype="multipart/form-data" >
                   @csrf 
                   @method("PUT")
				    {{csrf_field()}} 
					...
					<div class=' '>
						...
						<div class='overflow-scroll '>
                            ...
                            <textarea class="w-full h-96" name="description" >{{ $post->description }}</textarea>
						</div>
					</div>
					<div>
